...
require "../script/php/header_stock.php";
	...
	$get_lap_info  =new run_query("select * from stock where id='$stock_id' ");
						...
						$_SESSION['touchscreen'] = $touchscreen;
								...
								$get_model = new run_query("select * from laptop_model where model_name= '$model' ");
			...
			if( isset($_POST['save_stock']) ){
				...
				//	$RAMtype = addslashes(htmlentities($_POST['RAMtype']));
					...
					generation='$generation'  where id='$stock_id' ";
								...
								$check_lap_serail  =new run_query("select * from stock where serial='$serial' and  id !='$stock_id'");
						...
						if( $check_lap_serail->num_rows >= 1){
									...
									<b>  Laptop Serial Number/IMEI Already Exists!  Do You Still Want To Update?  </b><hr/>
		...
		<div class="col m5 l5 s12">
			...
			<div class="input-field col s12">
				...
				<select required name='model'>
				  ...
				  <option value='<?php echo $model_name; ?>' selected> <?php echo $model_name; ?> </option>

				  	<?php 

								$get_laptop_model = new run_query("select * from laptop_model  where model_name  !='$model_name' ");
				...
				<select required name='currentLocation'>
				   ...
				   <option value='<?php echo $location_id; ?>' selected> <?php echo $location_name; ?> </option>
						...
						<?php 
							 	...
							 	$sql_location = "select id as location_id, name as location_name  from $db1.business_locations where   id !='$location_id'  ";
			...
			<div class="row">
				...
				<div class="input-field col s12">
				  ...
				  <select name='HDD'>
				      ...
				      <option value="No Drive " <?php if( $extraHDD=='No Drive '){ echo "selected";}  ?>  >No Drive</option>
