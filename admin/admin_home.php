...
require "../script/php/header_admin.php";
		...
		$sql_location2 = "select name as user_location2 from $db1.business_locations where id='$user_location' ";
	...
	<?php   
						...
						if( isset($_POST['view_invoice']) ){
								...
								$get_payment_data =	$get_payment->result();										
											...
											$sql_location2 = "select name as user_location2 from $db1.business_locations where id='$invoice_location' ";
