...
<!-------
 ...
 <meta http-equiv="X-UA-Compatible" content="IE=edge">
  ...
  <meta http-equiv="pragma" content="no-cache" />
   ...
   <title> ALL RESTOCK LAPTOPS - OYEMART COMPUTERS </title>
<style>
...
?>	
   <div class="container">
   <h1 align='center' class=' tada blue-text'>  ALL RESTOCK LAPTOPS </h1>
<br/>
<form method='post'>
			...
			<div class="input-field col m3 l3 s12">
				<select required name='invoice_location'>
				  ...
				  <?php 
							 	...
							 	$sql_location = "select name as location_name, id as location_id from $db1.business_locations ";
								...
								$no =1;								
										while(	$get_invoice_data =	$get_invoice->result() ){
											...
											extract($get_invoice_data );
											 	...
											 	$sql_location = "select id as location_id, name as location_name  from $db1.business_locations where id= '$refund_locationId'  ";
												$get_locations = $connect ->query($sql_location);	
												...
												$refund_Amount = number_format("$refund_Amount",2,".",","); 
													echo "			
															...
															<ul class='collapsible popout ' data-collapsible='accordion'>
																<li>
																  <div class='collapsible-header deep-orange white-text'> $model ($RAM  RAM) REFUND(N$refund_Amount)  $refund_Date  </div>
