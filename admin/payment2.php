										...
										if(   is_numeric($amt_paid)  ){
											...
											$query_payment    =new run_query("insert into payments set paymentDate='$reg_Date', 
																								  ...
																								  posStan='$pos_stan',
																								   posDigit='$pos_digit'
																								  ");
													$query_stock  =new run_query(" update sales set balance_amt='$balance', amt_paid=amt_paid+$amt_paid where invoice_id='$invoice_id' ");											  
	 ...
	 <div class="row">
									...
									<div class="col m6 l6 s12">
										...
										<div class="card-content">
										  ...
										  <div class="input-field col m12 l12 s12">
											  <input  type="text"  readonly value='<?php echo $physical_invoice;?>' >
