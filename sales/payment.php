...
if( !isset( $_SESSION['charger_name'])  OR empty( $_SESSION['charger_name'])){
...
require "../script/php/header_sales.php";
				...
				$query_payment    = new run_query("insert into payments set paymentDate='$reg_Date', 
										...
										$query_stock1  =new run_query(" update stock set status='1', charger_id='$charger', price='$sales_price', dateSold='$reg_Date' where id='200' ");	
								 	...
								 	if( $_SESSION['charger'] != 'NO_CHARGER' ){
											...
											$sql_check = "insert into  charger set  
											charger_id='$charger', 
											laptop_id='$sell_stock_id',
								...
								$sql_run_check = new run_query($sql_check);	
															...
															window.location.replace(\"reciept.php?invoice_id=$invoice&customer_name=$customer_name&customer_address=$customer_address&customer_phone=$customer_phone\");
