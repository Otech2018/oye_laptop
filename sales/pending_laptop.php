					 ...
					 $get_cart = new run_query("select * from movements  where  status_move='PENDING' and sender='$user_id' ");
								...
								$no =1;								
									...
									while(	$get_cart_data =	$get_cart->result() ){
											...
											$sql_location = "select id as location_id, name as location_name  from $db1.business_locations  where id= '$reciver_location_id' ";
											...
											<tr>
												...
												<td>
													...
													<a  class='red-text modal-trigger' href='#stock$id' >   <i class='fa fa-info-circle'></i> Details</a>
					 ...
					 $get_cart1 = new run_query("select * from movements  where  status_move='PENDING' and receiver='$user_id' ");
								...
								$no =1;								
									...
									while(	$get_cart_data1 =	$get_cart1->result() ){
											...
											$sql_location = "select id as location_id, name as location_name  from $db1.business_locations  where id= '$sender_location_id' ";
