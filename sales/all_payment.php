...
<!-------
 ...
 <meta http-equiv="X-UA-Compatible" content="IE=edge">
  ...
  <meta http-equiv="pragma" content="no-cache" />
   ...
   <title> ALL PAYMENTS - OYEMART COMPUTERS </title>
...
?>	
   ...
   <h1 align='center' class=' tada blue-text'>  ALL PAYMENTS </h1>
				...
				<?php
							...
							if( isset($_POST['view_payment']) ){
								...
								if( $payment_location ==='all'){
								 ...
								 $get_payments = new run_query("select * from payments where  totalAmountPaid >=1 and  paymentDate between '$start_date' and  '$end_date'  order by pay_id desc");

								

								 }else{

								  $get_payments = new run_query("select * from payments  where totalAmountPaid >=1 and  locationId='$payment_location' and paymentDate between '$start_date' and  '$end_date'  order by pay_id desc ");
								...
								$no =1;								
											...
											extract($get_stock_data );
											 ...
											 if( $acc_details_id =="" or $acc_details_id =="not" or $acc_details_id =="0"){
													...
													echo "		
															...
															<ul class='collapsible popout ' data-collapsible='accordion'>
																...
																<li>
																  ...
																  <div class='collapsible-header deep-orange white-text'> $model ($RAM  RAM) (N$totalAmountPaid) $paymentDate </div>
